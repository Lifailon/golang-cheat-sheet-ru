...
- [Базовый синтаксис](#базовый-синтаксис)
  ...
  - [Типы последовательностей](#типы-последовательностей)
    - [Статические срезы (массивы)](#статические-срезы-массивы)
...
- [Программирование на Golang](https://stepik.org/course/54403) ⭐ 4.7 (1.1K отзыва, 73K учащихся), 35 урока, 64 теста, 94 задач.
- [PRO Go. Основы программирования](https://stepik.org/course/158385) - ⭐ 4.8 (214 отзывов, 18K учащихся), 38 урока, 121 тестов, 191 задач.
...
func main() {
    ...
    // range возвращает копию элемента, а не сам элемент массива, что бы изменить содержимое массива, необходимо обращаться к элементам по индексу
...
Массивы - фиксированная по размеру последовательность элементов (arr[10]).

Срезы (slice) - это динамическая структура, которая может быть получена из массивов или других срезов с помощью операции среза (arr[start:end]).

Диапазоны (range) - используются в циклах для перебора элементов в массиве.
...
chars := []string{0:"a", 2:"b", 1: "c"}     // задать порядок индексов при объявление среза [a c b]
